...
<nav class="navbar navbar-dark bg-dark">
    ...
    <div class="profile-image ">
        <img class="rounded-circle " src="C:\Users\User\Desktop\books\profile.jpg" width="60px" height="60px" alt="">
    </div>
</nav>
</body>
</html>
